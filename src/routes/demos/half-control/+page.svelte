<script>
    ...
    import HalfControlResonsive from '../../../lib/components/HalfControlResonsive.svelte';
...
<!-- <Checkbox labelText="Apply Whitespace condition" bind:checked={arConditions} id="whitespace"/> -->


<HalfControlResonsive {spec} bind:width bind:height bind:viewLandscape>
	{#if viewLandscape && landscapeOverlay}
		<ViewLandscapeOverlay {viewLandscape} />
	{/if}
</HalfControlResonsive>
